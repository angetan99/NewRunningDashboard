        ...
        <body>
          <div class="container">
            <header>
              ...
              <p style="color: #666;">Zhou Family Running Challenge Dashboard</p>
            </header>
    ...
    res.send(`
      ...
      <head>
        ...
        <style>
          ...
          .feature h3 { color: #FC5200; margin-bottom: 10px; }
          .powered-by { margin-top: 40px; font-size: 12px; color: #666; }
          a { color: #FC5200; text-decoration: none; font-weight: bold; }
        </style>
      </head>
      <body>
        <div class="hero">
          <h1>🏃 Zhou Family Running Challenge</h1>
          <p class="subtitle">Track your year-long running journey</p>
          ...
          <div class="features">
            <div class="feature">
              ...
              <p>Run month.day miles daily (e.g., 1.26 on Jan 26)</p>
            </div>
            <div class="feature">
              <h3>🎫 Bailout Passes</h3>
              <p>4 passes to skip tough days</p>
            </div>
            <div class="feature">
              <h3>⚠️ Streak Rules</h3>
              <p>3 consecutive misses = elimination</p>
            </div>
            <div class="feature">
              <h3>🏆 Compete</h3>
